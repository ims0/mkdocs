...
!!! note "PS"
    在 Linux 操作系统中，线程的内核对象与进程的内核对象(其实就是一些结构体变量)是很类似的，所以线程可以说是轻量级的进程。
...
## <font color="#0099ff"> 1. 对于实时任务</font>
...
## <font color="#0099ff"> 2. 对于普通任务</font>
...
1.  用命令查看当前nice值：
`ps -ely`
2.  用renice调整,对pid为100的进程调整nice值为10; `renice 10 100`
